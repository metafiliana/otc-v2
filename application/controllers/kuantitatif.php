...
class Kuantitatif extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('mkuantitatif_update');
...
//        die;
        ...
        $prog['list_program'] = $this->load->view('program/component/_list_of_kuantitatif',$prog,TRUE);

        $data['footer'] = $this->load->view('shared/footer','',TRUE);
        $data['header'] = $this->load->view('shared/header-new','',TRUE);
        //$data['sidebar'] = $this->load->view('shared/sidebar_2',$prog,TRUE);
        $data['content'] = $this->load->view('program/list_kuantitatif',$prog,TRUE);
...
//        die;
    ...
    public function list_programs(){
        ...
        $prog['list_program'] = $this->load->view('program/component/kuantitatif',$prog,TRUE);
        $data['footer'] = $this->load->view('shared/footer','',TRUE);
        $data['header'] = $this->load->view('shared/header-new','',TRUE);
        //$data['sidebar'] = $this->load->view('shared/sidebar_2',$prog,TRUE);
    ...
    public function change_data(){
        ...
        $json['html'] = $this->load->view('program/component/_list_of_kuantitatif',$data,TRUE);
