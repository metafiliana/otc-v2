...
<div style="margin-top:75px;" class="grey_color">
	<div style="padding-left:20px">
		<div style="margin-bottom:10px; margin-left:25px;"><img src="<?php echo base_url();?>assets/img/general/no-profile-img.gif" alt="..." class="img-circle" style="height:80px;"></div>
		<div class="black_color" style="font-size:13px;margin-left:25px;"><?php echo $user['name']?></div>
		<div class="black_color" style="font-size:11px;margin-left:25px;"><?php echo $user['role']?></div>
	</div>
