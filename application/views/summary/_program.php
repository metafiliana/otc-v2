...
<div class="panel-group" id="accordion">
    <?php
        foreach ($programs as $key => $value) {
            ...
            echo "<a class = 'filter-value-detail-program-list' data-id = '".$value['init_code']."' data-toggle='collapse' data-parent='#accordion' href='#collapse".$value['id']."'>".$value['segment']." ( ".$value['init_code']." ) : (".$value['percent']."%)</a></h4></div>";
