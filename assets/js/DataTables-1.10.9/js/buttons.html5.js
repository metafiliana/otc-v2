...
DataTable.ext.buttons.excelHtml5 = {
	...
	text: function ( dt ) {
		return dt.i18n( 'buttons.excel', '<span style="margin-right:5px;" class="glyphicon glyphicon-th"></span> Export to Excel' );
	},
...
DataTable.ext.buttons.pdfHtml5 = {
	className: 'buttons-pdf buttons-html5 btn-danger',
	...
	text: function ( dt ) {
		return dt.i18n( 'buttons.pdf', '<span style="margin-right:5px;" class="glyphicon glyphicon-file"></span> Export to PDF' );
	},
