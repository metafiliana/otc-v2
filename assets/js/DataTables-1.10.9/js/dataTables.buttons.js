	...
	pageLength: function ( dt ) {
		...
		var text = function ( dt ) {
			return dt.i18n( 'buttons.pageLength', {
				"-1": '<span style="margin-right:5px;" class="glyphicon glyphicon-search"></span> Show all rows',
				_:    '<span style="margin-right:5px;" class="glyphicon glyphicon-search"></span> Show %d rows'
			}, dt.page.len() );
		};
		...
		return {
			extend: 'collection',
			text: text,
			className: 'buttons-page-length btn-default',
			autoClose: true,
